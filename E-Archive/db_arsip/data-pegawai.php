...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./styles/data-pegawai.css"/>
        <title>Halaman Data Pegawai</title>
    </head>

    <body>
    <div class="dtpegawai">
      <div class="dtpegawai-sidebar" style="justify-content: center; text-align: center">
        <ul>
          <li>
          ...
          <a href="form-dtpegawai.php">
            ...
            ?>
                ...
                <table border="1">
                    ...
                    INNER JOIN unit_kerja ON tbl_pegawai.id_uk = unit_kerja.id_uk");
                    ...
                    <td><?= $row['jabatan']; ?></td>
                    <td><?= $row['skpd']; ?></td>
                    <td align="center"><a href="edit-pegawai.php?id_pegawai=<?php echo $row['id_pegawai']; ?>"><img src="./assets/edit1.png" style="width: 40px;" onclick="return confirm('Yakin Ingin Mengedit Data?')"></a>
                        <a href="delete-pegawai.php?id_pegawai=<?php echo $row['id_pegawai']; ?>"><img src="./assets/trash.png" style="width: 40px;" onclick="return confirm('Yakin Ingin Menghapus Data?')"></a></td>
                    </tr>
